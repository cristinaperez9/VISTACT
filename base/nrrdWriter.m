% ----------------------------------------------------------------------------------------------------------------------
% This function was developed by mdcacio under MATLAB Central File Exchange, and can be found in the following link:
%(https://www.mathworks.com/matlabcentral/fileexchange/48621-nrrdwriter-filename-matrix-pixelspacing-origin-encoding), 
% In the current project was used to save the 3D Collagen segmentation masks and then render them in Paraview software.
% ----------------------------------------------------------------------------------------------------------------------
