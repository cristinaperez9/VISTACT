% -------------------------------------------------------------------------
% This function (and its dependency natsort) enable to sort alphabetically 
% the names of the files insider a folder.
% It was developed by Stephen23 (MATLAB Central File Exchange). The link to the repository is:
